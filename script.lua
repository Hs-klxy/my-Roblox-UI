...
Button.TextColor3 = Color3.fromRGB(9, 132, 255)
...
element.Name = "BorderedElement"
element.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
element.BorderColor3 = Color3.fromRGB(60, 60, 60) -- 边框颜色
element.BorderSizePixel = 0 -- 边框粗细

-- 如果想去掉所有边框，可以设置 BorderSizePixel 为 0:cite[9]
...
TabGames:AddButton({
    ...
    Callback = function()
        ...
        local knife = ReplicatedStorage:FindFirstChild("刀")
...
TabGames:AddParagraph("🔪 murder Mystery脚本", "这是关于MM2的脚本")

TabGames:AddButton({
    Name = "MM2 - arlenwood的脚本",
    Callback = function()
        OrionLib:MakeNotification({
            Name = "加载中",
            Content = "正在加载arlenwood的脚本...",
            Image = "rbxassetid://4483345998",
            Time = 3
        })
...
TabGames:AddParagraph("🦹🏿‍♂️ jailbreak脚本", "这些是关于越狱的脚本")

TabGames:AddButton({
    Name = "越狱 - jailbreak regular script",
    Callback = function()
        OrionLib:MakeNotification({
            Name = "加载中",
            Content = "正在加载jailbreak regular script",
            Image = "rbxassetid://4483345998",
            Time = 3
        })
        loadstring(game:HttpGet('https://raw.githubusercontent.com/Sufyan123-bit/Scripts/refs/heads/main/jailbreakregularscript.lua'))()
    end    
})

TabGames:AddButton({
    Name = "越狱 - a fanmade script",
    Callback = function()
        OrionLib:MakeNotification({
            Name = "加载中",
            Content = "正在加载一个游戏粉丝制作的脚本...",
            Image = "rbxassetid://4483345998",
            Time = 3
        })
...
Tab3:AddButton({
    ...
    Callback = function()
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/jLn0n/scripts/main/backdoor-executor/backdoor-executor.lua"))()
    end    
})
